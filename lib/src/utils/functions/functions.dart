...
abstract class UtilFunctions {
  ...
  static const List<Color> backgroundColors = [
    ...
    AppColors.lightCoralBackground,
    AppColors.lightGoldenrodBackground,
    AppColors.lavenderBackground,
    AppColors.lightSalmonBackground,
    AppColors.powderBlueBackground,
    AppColors.mistyRoseBackground,
    AppColors.paleTurquoiseBackground,
    AppColors.thistleBackground,
  ];
  ...
  static Color getBgColor() {
    //get random color from backgroundColors
  ...
  static Color getContrastRandomColor(Color a) {
    return a.computeLuminance() > 0.5 ? Colors.black : Colors.white;
  }
